...
export default function Manage() {
  return (
    <div className=" relative px-5 md:pl-[72px] sm:px-6 flex flex-col space-y-8 bg-[#1C4670] overflow-hidden text-white py-[58px]">
      <div className="w-[540px] flex items-start flex-col space-y-8">
      ...
      <img
        src="./Manage3.png"
        className="absolute top-[194px] right-[391px] w-[308px] h-[619px]"
        alt="Manage App"
      />
      <img
        src="Manage3.png"
        className="absolute top-[26px] right-[52px] w-[308px] h-[619px]"
        alt="Manage App"
      />
    </div>
  );
